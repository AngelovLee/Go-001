...
```shell
2020/12/20 01:07:06 grpc server start: :9800
```
...
2020/12/20 01:16:21 register user id: 100
```
...
```shell
2020/12/20 01:16:17 grpc server start: :9800
2020/12/20 01:16:21 save user, name: zhangsan, age: 20, id: 100
2020/12/20 01:16:24 signal caught: interrupt, ready to quit...
2020/12/20 01:16:24 grpc server gracefull stop
```
